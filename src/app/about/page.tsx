    ...
    return (
        <main className="min-h-screen bg-[#f4f1ee] text-black font-serif selection:bg-orange-500 selection:text-white">
            ...
            <header className="grid grid-cols-12 border-b border-black/10 sticky top-0 bg-[#f4f1ee]/90 backdrop-blur-sm z-50">
                <div className="col-span-6 md:col-span-3 border-r border-black/10 p-6 flex items-center">
                    <h1 className="text-xl tracking-tight">Theory Ventures</h1>
                </div>
                ...
                <div className="border-r border-black/10 p-8 md:p-16 flex flex-col justify-between">
                    ...
                    <div className="space-y-8 max-w-xl">
                        <h2 className="text-4xl md:text-6xl leading-[1.1] font-medium">
                            We back founders building the future of software.
                        </h2>
                        <p className="text-lg md:text-xl leading-relaxed opacity-70 font-sans font-light">
                            We invest $1-5M in early-stage technical teams. We believe in high-conviction, low-volume investing. We don't play the lottery; we build the protocol.
                        </p>
                    </div>
            ...
            <footer className="grid grid-cols-1 md:grid-cols-2 min-h-[40vh]">
                <div className="border-r border-black/10 p-12 flex flex-col justify-end">
                    <a href="mailto:hello@theory.vc" className="text-2xl hover:underline decoration-1 underline-offset-4">hello@theory.vc</a>
                </div>
